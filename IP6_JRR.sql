...
/* By initially having the parameters backward, I found 3 anomalies where the date_reported was earlier than the 
date_occured */
/* 9663 */
...
FROM incident_reports
WHERE crime_type = 'VEHICLE THEFT'
GROUP BY zip_code
ORDER BY COUNT(crime_type) DESC;
/*NEED TO RUN THIS AHHHHHHHHHHHHHHHHHHHHHH*/
...
/* 17. Write the query to show the zip code and the type of entity the offense was against. In your results, remove
any rows with and NIBRS code and an invalid zip code. You can do that with the LENGTH function in
